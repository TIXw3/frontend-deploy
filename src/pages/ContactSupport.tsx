      ...
      {activeTab === 'contact' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-lg font-medium text-gray-800 dark:text-gray-100">(45) 9103-0908</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-lg font-medium text-gray-800 dark:text-gray-100">atixup@gmail.com</p>
          </div>
